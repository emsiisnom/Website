            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{url('admin/category-list')}}">Show All</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
                    ...
                    <tbody>
                      @foreach ($cat as $c)
                        <tr>
                          ...
                          <td>{{$c->catName}}</td>
                          <td>
                            <a href="{{url('admin/category-edit')}}\{{$c->catID}}" title="Edit this product">Edit</a> &nbsp; &nbsp;
                            <a href="{{url('admin/category-delete')}}\{{$c->catID}}" title="Delete this product" onclick="return confirm('Are you sure delete this product?');">Delete</a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
