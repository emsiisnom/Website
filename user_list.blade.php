                    ...
                    <tbody>
                      @foreach ($u as $us)
                        <tr>
                          ...
                          <td>{{$us->userPhone}}</td>
                          <td> 
                            <img src="{{'../../public/img/'. $us -> userProfile}}" title="View product details"
                            width="300px" height="200px">
                            <a href="{{url('user-edit')}}\{{$us->userID}}" title="Edit this product">Edit</a> &nbsp; &nbsp;
                            <a href="{{url('user-delete')}}\{{$us->userID}}" title="Delete this product" onclick="return confirm('Are you sure delete this product?');">Delete</a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
